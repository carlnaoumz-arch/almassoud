...
export default defineConfig({
  plugins: [tailwindcss(), vinext(), nitro({
    preset: 'vercel',
    routeRules: { '/farrouj-mobile-hevc-v1.mp4': { headers: { 'cache-control': 'public, max-age=31536000, immutable' } }, '/farrouj-mobile-hd-v1.mp4': { headers: { 'cache-control': 'public, max-age=31536000, immutable' } },
