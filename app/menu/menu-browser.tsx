...
export function MenuBrowser() {
 ...
 const visible=menuSections.map(section=>({...section,items:section.items.filter(item=>`${section.title} ${item.name} ${item.description}`.toLowerCase().includes(term))})).filter(section=>section.items.length);
