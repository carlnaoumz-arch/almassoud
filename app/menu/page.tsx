...
export default function MenuPage() {
  return <main className="menu-catalog" id="top">
    ...
    <footer><div className="footer-top"><Link href="/#top" className="footer-brand"><img src="/logo.png" alt="Al Massoud" width="180" height="67"/></Link><p>Good food made good.<br/><span>Made to bring us together.</span></p></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Al Massoud</span><a href="#top">BACK TO TOP ↑</a></div></footer>
  </main>;
}
